...
//        BrandModelsPage productsPage = homePage.selectBrand("Samsung");
        BrandModelsPage brandModelsPage = homePage.selectBrand("Samsung");

//        ModelInfoPage productInfoPage = productsPage.selectModel("Galaxy A52 5G");
        ModelInfoPage modelInfoPage = brandModelsPage.selectModel("Galaxy A52 5G");

        SoftAssert softAssert = new SoftAssert();
        softAssert.assertEquals(modelInfoPage.readDisplay(), "6.5\"", "Invalid display info!");
        softAssert.assertEquals(modelInfoPage.readCamera(), "64MP", "Invalid camera info!");
        softAssert.assertEquals(modelInfoPage.readRam(), "6/8GB RAM", "Invalid ram info!");
        softAssert.assertEquals(modelInfoPage.readBattery(), "4500mAh", "Invalid battery info!");
